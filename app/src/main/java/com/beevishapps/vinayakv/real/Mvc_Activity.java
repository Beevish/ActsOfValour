...
public class Mvc_Activity extends AppCompatActivity {
   ...
   // private CollapsingToolbarLayout collapsingToolbarLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mvc_);



        recyclerView = (RecyclerView) findViewById(R.id.mvcRc);//.......................................taking the new recycler view;
        ...
        mAdapter= new HeroPicAdapter(Mvc_Activity.this,responseObj.getHeros());
...
//        dynamicToolbarColor();
    ...
    public String loadJSONFromAsset() {
        ...
        try {
            ...
            InputStream is = getAssets().open("mvcData.json");
