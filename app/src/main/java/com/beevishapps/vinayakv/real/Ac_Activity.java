...
public class Ac_Activity extends AppCompatActivity {
   ...
   // private CollapsingToolbarLayout collapsingToolbarLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ac_);

        recyclerView = (RecyclerView) findViewById(R.id.acRc);//.......................................taking the new recycler view;
        ...
        mAdapter= new HeroPicAdapter(Ac_Activity.this,responseObj.getHeros());
...
//        dynamicToolbarColor();
    ...
    public String loadJSONFromAsset() {
        ...
        try {
            ...
            InputStream is = getAssets().open("acData.json");
