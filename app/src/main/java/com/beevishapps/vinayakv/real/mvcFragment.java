...
public class mvcFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.mvcRcFragment);//.......................................taking the new recycler view;
    ...
    private String loadJSONFromAsset() {
        ...
        try {
            ...
            InputStream is = getActivity().getAssets().open("mvcData.json");
    ...
    public void onResume() {
        ...
        ((MainActivity) getActivity()).setActionBarTitle("Maha Veers");
    }
